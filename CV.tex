...
\begin{document}
	...
	\subsection{Review/Preprint}
	\begin{etaremune}
		\item \textit{Half-sided Translations and Islands}, (with Roji Pius), 2023, \href{https://arxiv.org/abs/2312.11085}{[2312.11085]}.
		\item \textit{Generalized Second Law for Non-minimally Coupled Matter Theories}, (with Prateksh Dhivakar), under review, 2023, \href{https://arxiv.org/abs/https://arxiv.org/abs/2309.12782}{[2309.12782]}.
	\end{etaremune}

	\section{Conferences/Workshops}
	\subsection{Invited Talks}
	\begin{enumerate}
		\item Chennai Strings Meeting 2023, jointly organized by CMI-IMSc-IIT Madras, India, November 2023.
	\end{enumerate}
	
	\subsection{Poster Presentation}
	\begin{enumerate}
		\item \textit{Half-sided Translations and Islands}, Indian Strings Meeting 2023, IIT Bombay, Mumbai, India, December 2023.
	\end{enumerate}
	...
	$^*$ All the courses assisted at \imsc\ were graduate level courses. The duties involved ranged from preparation and grading of assignments to conducting tutorial sessions for a class size of about 5-10 students.
