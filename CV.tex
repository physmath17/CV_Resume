...
\renewcommand{\maketitle}{
	...
	\begin{minipage}[t]{.35\textwidth}
		...
		\vspace{3pt}
		\par{\centering{\hfill{}\hspace{22pt}\color{gray} \email{} :
				\href[gray]{mailto:krishnajalan.imsc@gmail.com}{krishnajalan.imsc@gmail.com} \hfill}\par}
		\vspace{3pt}
...
\begin{document}
	...
	\hfill \begin{minipage}{\dimexpr\textwidth-0.5cm}
		\begin{itemize}[noitemsep]
			\item Quantum information aspects of quantum field theory and quantum gravity;
			\item Black hole information paradox;
			\item Gauge/gravity duality.
		\end{itemize}
	\end{minipage}
	...
	\entry{Aug 2014 -- May 2019}{(Integrated) M.Sc. in Physics}{\nitr}{Thesis : Anisotropic Thermalization in Strongly Coupled Field Theory via Gauge/Gravity Duality \\ Supervisor : \href{https://website.nitrkl.ac.in/FProfile.aspx?e=mahapatrasub}{Subhash Chandra Mahapatra}}
	...
	\begin{etaremune}
		\item Prateksh Dhivakar and \textbf{Krishna Jalan}. \emph{Generalized second law for non-minimally coupled matter theories}. \emph{Class. Quant. Grav.}, 41(15):155003, 2024. \href{https://arxiv.org/abs/2309.12782}{[2309.12782]}
	\end{etaremune}	
	
	\subsection{Under Review/Preprint}
	\begin{etaremune}
		\item \textbf{Krishna Jalan}, Roji Pius, and Manish Ramchander. \textit{Half-sided Translations and the Information Recovery from Radiation}, 2023, \href{https://arxiv.org/abs/2312.11085}{[2312.11085]}.
		
		\item \textbf{Krishna Jalan} and Roji Pius. \textit{Half-sided Translations and Islands}, 2023, \href{https://arxiv.org/abs/2312.11085}{[2312.11085]}.
	\end{etaremune}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item \colentry{\emph{Chennai Strings Meeting}, jointly organized by CMI-IMSc-IIT Madras, India}{November 2023}
		\end{itemize}
	\end{itemize}
	...
	$^*$ All the courses assisted at \imsc\ were graduate level courses. The duties involved preparation and grading of assignments and conducting tutorial sessions for a class size of about 5-10 students.
	
	\slimentry{Spring 2024}{\textbf{Teaching Assistant for Quantum Mechanics II} \\ \imsc}
	
	\slimentry{Fall 2023}{\textbf{Teaching Assistant for Electromagnetic Theory} \\ \imsc}
	...
	\slimentry{Oct 2022}{Taught an online problem solving session to a group of 15 students preparing for the \textbf{Indian Olympiad Qualifier in Mathematics} during a training camp organized by the \textit{Assam Academy of Mathematics, Bongaigaon Branch, Assam}.}
	...
	\entry{Languages}{Marwadi (mother tongue), Hindi (fluent), English (fluent), Assamese (basic), Bengali (basic), Japanese (basic, spoken).}{}{}
	
	\section{Non-academic Duties}
	\entry{Feb 2023}{Organizer of the Freshers' event}{\imsc}{Organized the Freshers' event to welcome the new members of the institute.}
