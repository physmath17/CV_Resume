...
\begin{document}
	...
	\begin{enumerate}
		\item \textit{Half-sided Translations and Islands}. Chennai Strings Meeting 2023, jointly organized by CMI-IMSc-IIT Madras, India, November 2023.
	\end{enumerate}
	...
	\entry{Languages}{Marwadi (mother tongue), Hindi (fluent), English (fluent), Assamese (basic), Bengali (basic), Japanese (basic).}{}{}
